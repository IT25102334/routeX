...
/** Premium ride: higher base + per-km rate, larger surge multiplier at peak hours. */
public class PremiumFareStrategy implements FareStrategy {

    private static final BigDecimal BASE_FARE = new BigDecimal("250.00");
    private static final BigDecimal PER_KM_RATE = new BigDecimal("95.00");
    private static final BigDecimal SURGE_MULTIPLIER = new BigDecimal("1.75");
